...
测试覆盖 Chromium、Firefox、WebKit、Pixel 7 Android Chrome、Galaxy S8 窄屏 Android Chrome 和 iPhone 14 Safari 移动视口，验证页面加载、启动登录门、导航、情绪记录、随笔列表、气象导图、气象历点位、呼吸/专注/设置入口与 PWA 元数据。
